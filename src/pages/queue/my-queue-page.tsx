...
import { IconTicket, IconRefresh, IconX, IconCheck } from "@tabler/icons-react"
...
const useQueueUpdates = (queueNumber: string | null) => {
    ...
    return {
        queuePosition: Math.floor(queuePosition),
        peopleAhead: Math.floor(peopleAhead),
        estimatedWaitMinutes: Math.floor(estimatedWaitMinutes),
    }
}
...
export default function MyQueuePage() {
    ...
    const progressPercentage = studentData.currentQueue ? Math.max(10, 100 - peopleAhead * 20) : 0
    ...
    return (
        <SidebarProvider>
            {/* The Sidebar primitives already switch to an off-canvas Sheet on mobile, so no changes needed here for responsiveness. [^1] */}
                ...
                <main className="flex flex-1 flex-col gap-6 p-4 lg:gap-8 lg:p-6">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground">Manage your current queue status and track your position</p>
                        </div>
                        <Button
                            variant="outline"
                                    ...
                                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <CardDescription className="text-blue-700">You are currently in the queue</CardDescription>
                                            </div>
                                        </div>
                                        <Badge variant="secondary" className="bg-blue-100 text-blue-800 px-3 py-1 w-fit">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-start sm:items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">{studentData.currentQueue.service}</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start sm:items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">+63{studentData.currentQueue.phoneNumber}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="space-y-4">
                                            <div className="flex items-start sm:items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">{estimatedWaitMinutes} minutes remaining</p>
                                                </div>
                                            </div>
                                            <div className="flex items-start sm:items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">#{queuePosition} in line</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Your recent queue entries and their status</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                {studentData.queueHistory.slice(0, 3).map((entry) => (
                                    ...
                                    >
                                        <div className="flex items-start sm:items-center gap-3">
                                            <div
                                                className={`p-2 rounded-full ${entry.status === "Completed"
                                                    ? "bg-green-100"
                                            ...
                                            >
                                                <IconTicket
                                                    className={`h-4 w-4 ${entry.status === "Completed"
                                                        ? "text-green-600"
                                                        : entry.status === "In Progress"
                                                            ? "text-blue-600"
                                                            : "text-red-600"
                                            ...
                                            className={
                                                entry.status === "Completed"
                                                    ...
                                                    : entry.status === "In Progress"
                                                        ...
                                                        : "bg-red-100 text-red-800 border-red-200 w-fit"
                                            }
                                        >
                                            {entry.status}
                                        </Badge>
                                ...
                                {studentData.queueHistory.length === 0 && (
                                    <div className="text-center py-8 text-muted-foreground">No queue history found</div>
                                )}
                            </div>
                        </CardContent>
                    </Card>
