...
export default function StaffSettingsPage() {
    ...
    const baseName = (stored?.name as string | undefined) ?? sessionUser?.name ?? "Staff"
    ...
    const dashboardUser: DashboardUser | undefined = React.useMemo(() => {
        ...
        return {
            name,
            email,
            avatarUrl: (sessionUser as any)?.avatarUrl ?? (stored as any)?.avatarUrl ?? undefined,
        }
    ...
    return (
        <DashboardLayout title="Staff settings" navItems={STAFF_NAV_ITEMS} user={dashboardUser} activePath={location.pathname}>
